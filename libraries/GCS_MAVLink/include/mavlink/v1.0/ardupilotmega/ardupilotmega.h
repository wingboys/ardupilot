...
#include "./mavlink_msg_gdpilot_status.h"
#include "./mavlink_msg_battery_neitzke.h"
#include "./mavlink_msg_ambient_neitzke.h"
#include "./mavlink_msg_magnetometer_neitzke.h"
