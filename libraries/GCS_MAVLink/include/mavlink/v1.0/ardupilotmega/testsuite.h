...
static void mavlink_test_local_position_neitzke(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_LOCAL_POSITION_NEITZKE >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
	...
	mavlink_local_position_neitzke_t packet_in = {
		963497464,45.0,73.0,101.0,963498296,157.0,185.0,213.0,241.0,269.0,19315,3,70
    };
	mavlink_local_position_neitzke_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_LOCAL_POSITION_NEITZKE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_LOCAL_POSITION_NEITZKE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
	...
	mavlink_msg_local_position_neitzke_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_local_position_neitzke_pack(system_id, component_id, &msg , packet1.time_boot_ms , packet1.position_ok , packet1.x , packet1.y , packet1.z , packet1.baro_alt , packet1.vx , packet1.vy , packet1.vz , packet1.pitch , packet1.roll , packet1.hdg , packet1.flight_stage );
	mavlink_msg_local_position_neitzke_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_local_position_neitzke_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_boot_ms , packet1.position_ok , packet1.x , packet1.y , packet1.z , packet1.baro_alt , packet1.vx , packet1.vy , packet1.vz , packet1.pitch , packet1.roll , packet1.hdg , packet1.flight_stage );
	mavlink_msg_local_position_neitzke_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_local_position_neitzke_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_local_position_neitzke_send(MAVLINK_COMM_1 , packet1.time_boot_ms , packet1.position_ok , packet1.x , packet1.y , packet1.z , packet1.baro_alt , packet1.vx , packet1.vy , packet1.vz , packet1.pitch , packet1.roll , packet1.hdg , packet1.flight_stage );
	mavlink_msg_local_position_neitzke_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
